...
I thrive at the intersection of engineering, product, and innovation-turning complex problems into clear, impactful solutions.
I’m passionate about software engineering, algorithms, and systems, and I bring hands-on experience from both academia and industry to every project I work on.
...
## 📝 Some of my Projects
 - 🧬 [**Collagen Variant Annotation Pipeline (hEDS Research)**](#)  
   End-to-end genomic pipeline integrating ClinVar, VEP, dbNSFP, gnomAD, and Mutalyzer to annotate 35,000+ collagen variants. Processes **1TB of biological annotation data**, including 80M+ dbNSFP records. Optimized database performance using SQLite indexing, reducing annotation lookups from 22 hours to 40 minutes **(33× speedup)**. Supports pathogenicity scoring, glycine-hotspot mapping, and ECM candidate-gene prioritization for hEDS research.
